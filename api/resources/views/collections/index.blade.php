        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <span>All Style Collections added.</span>
                </div>
            ...
            <table class="table mb-0 text-nowrap">
                ...
                <tbody>
                    @foreach ($collections as $item)
                        <tr class="align-items-center" style="">
                            <td class="border-top-0">
                                <div class="d-lg-flex">
                                    <div>
                                        <a href="{{route('categories', encrypt($item->id))}}">
                                            <img src="{{$item->featured_image}}" alt=""
                                                class="rounded img-4by3-md" /></a>
                                    </div>
                                    <div class="ms-lg-3 mt-2 mt-lg-0">
                                        <h4 class="mb-1 h5">
                                            <a href="{{route('categories', encrypt($item->id))}}" class="text-inherit">
                                                {{$item->name}}
                                            </a>
                                        </h4>
                            ...
                            <td class="text-muted border-top-0">
                                <span class="dropdown dropstart">
                                    ...
                                    <span class="dropdown-menu" aria-labelledby="courseDropdown">
                                        <a class="dropdown-item" href="{{route('collection', encrypt($item->id))}}"><i
