...
class _HomeScreenState extends State<HomeScreen> {
  ...
  var _coins = 0;
  final Uri _developerPageUrl = Uri.parse('https://play.google.com/store/apps/dev?id=4902014824566905372');
...
class ShowAllBtn extends StatelessWidget {
  ...
  const ShowAllBtn({super.key, required this.label, required this.onTap});
